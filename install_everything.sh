...
sudo apt-get -y install ros-melodic-mavros ros-melodic-mavros-extras
...
# additional ros things
sudo apt-get -y install ros-melodic-cv-bridge ros-melodic-image-transport

# install git, ssh, vim, and opencv
sudo apt-get -y install git openssh-server vim libopencv-dev
